// service worker (версия по содержимому: a81d839373)
// страница игры — network-first (всегда свежая при интернете), офлайн — из кэша.
const CACHE = 'mark-kart-a81d839373';
  ...
  e.waitUntil((async () => {
    ...
    try {
      ...
      for (const w of окна) {
        ...
        if (адрес.searchParams.get('v') === 'a81d839373') continue;
        адрес.searchParams.set('v','a81d839373');
