// service worker (версия по содержимому: 97905f8faa)
// страница игры — network-first (всегда свежая при интернете), офлайн — из кэша.
const CACHE = 'mark-kart-97905f8faa';
  ...
  e.waitUntil((async () => {
    ...
    try {
      ...
      for (const w of окна) {
        ...
        if (адрес.searchParams.get('v') === '97905f8faa') continue;
        адрес.searchParams.set('v','97905f8faa');
